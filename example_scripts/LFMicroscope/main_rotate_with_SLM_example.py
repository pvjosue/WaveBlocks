...
# from microscopes.microLF_PM import Microscope as MicroscopeWithSLM
# from microscopes.microWithPropagation import Microscope as MicroscopeDefocus
from waveblocks import blocks as ob
from waveblocks.microscopes.lightfield_pm_micro import Microscope as MicroscopeWithSLM
from waveblocks.microscopes.propagation_micro import Microscope as MicroscopeDefocus
...
Gt_img = torch.nn.functional.interpolate(
    obj_image.transpose(2, 3), obj_image.shape[-2:]
)
