...
class OpticConfig(nn.Module):
	...
	def get_default_PSF_config():
		...
		psf_config.ti0 = 150	# Microns, working distance (immersion medium thickness) design value
		...
		psf_config.zv = 0		# Offset of focal plane to coverslip, negative is closer to objective
